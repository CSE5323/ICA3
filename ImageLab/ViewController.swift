...
class ViewController: UIViewController   {
    ...
    func processImage(_ inputImage:CIImage) -> CIImage{
        ...
        let hasFinger = self.bridge.processImage()
        retImage = self.bridge.getImageComposite() // get back opencv processed part of the image (overlayed on original)
        
        if(hasFinger){
            NSLog("Finger is over camera");
        }
        self.toggleFlashButton.isEnabled = !hasFinger;
        self.toggleFlashButton.isHighlighted = !hasFinger;
        self.toggleCameraButton.isEnabled = !hasFinger;
        self.toggleCameraButton.isHighlighted = !hasFinger;
